...
export class Renderer {
  ...
  private drawBoardLines(geometry: import('./view-model.js').RendererGeometry): void {
  ...
  private drawStars(geometry: import('./view-model.js').RendererGeometry, stars: import('../types.js').Position[]): void {
