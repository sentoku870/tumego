 ...
 */
export function extractMetadata(rawText, initial) {
    const info = { ...initial };
 ...
 */
export function createDefaultGameInfo() {
    return {
        title: '',
 ...
 */
export function sgfColorToStoneColor(sgfColor) {
    return sgfColor.toUpperCase() === 'B' ? 1 : 2;
}
//# sourceMappingURL=sgf-metadata.js.map